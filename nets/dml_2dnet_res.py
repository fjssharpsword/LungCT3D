...
def bayes_resnet50(k_size=[3, 3, 3, 3], num_classes=1000, pretrained=False):
    ...
    Args:
        ...
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Bayes_ResNet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def bayes_resnet101(k_size=[3, 3, 3, 3], num_classes=1_000, pretrained=False):
    ...
    Args:
        ...
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Bayes_ResNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
def bayes_resnet152(k_size=[3, 3, 3, 3], num_classes=1_000, pretrained=False):
    ...
    Args:
        ...
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = Bayes_ResNet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, k_size=k_size)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    return model
...
if __name__ == "__main__":
    ...
    model = bayes_resnet152(num_classes=100, k_size=[3, 3, 3, 3]).cuda()
    out = model(x)
    print(out.shape)