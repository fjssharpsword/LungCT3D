...
import torchvision
#define by myself
from nets.spec_unconv import BayesConvNd
...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    #return BayesConvNd(in_channels=in_planes, out_channels=out_planes, kernel_size=3, convN=2, stride=stride, power_iterations=1)
...
if __name__ == "__main__":
    ...
    model = bayes_resnet18(num_classes=15).cuda()
    out = model(x)
    print(out.shape)