...
class _DenseLayer(nn.Module):
    def __init__(
        ...
        #self.add_module('conv1', WeightNormalization(nn.Conv2d(num_input_features, bn_size * growth_rate, kernel_size=1, stride=1, bias=False)))
        ...
        #self.add_module('conv2', WeightNormalization(nn.Conv2d(bn_size * growth_rate, growth_rate, kernel_size=3, stride=1, padding=1, bias=False)))
