...
max_epoches = 50
batch_size = 256
CKPT_PATH = '/data/pycode/LungCT3D/ckpt/fashionmnist_densenet_sconv.pkl'
def Train():
    print('********************load data********************')
    ...
    for epoch in range(max_epoches):
        ...
        log_writer.add_scalars('CrossEntropyLoss/Fashion-MNIST-DenseNet', {'SConv':np.mean(loss_train)}, epoch+1)
