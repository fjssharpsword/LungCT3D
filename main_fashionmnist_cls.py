...
max_epoches = 50
batch_size = 256
CKPT_PATH = '/data/pycode/LungCT3D/ckpt/fashionmnist_resnet_conv_mf.pkl'
def Train():
    print('********************load data********************')
    ...
    for epoch in range(max_epoches):
        ...
        log_writer.add_scalars('CELoss/FashionMNIST', {'train':np.mean(loss_train), 'val':np.mean(loss_test)}, epoch+1)
