...
from data_cxr2d.vincxr_coco import get_box_dataloader_VIN, get_box_dataloader_VIN_CVTE
...
CKPT_PATH = '/data/pycode/LungCT3D/ckpt/vincxr_densenet_conv.pkl'
...
def VINTrain():
    print('********************load data********************')
    data_loader_box_train = get_box_dataloader_VIN_CVTE(batch_size=BATCH_SIZE, shuffle=True, num_workers=0)
